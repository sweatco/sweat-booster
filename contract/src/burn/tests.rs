...
fn burn_token_by_oracle_for_valid_owner() {
    ...
    let reference_booster_data = BalanceBoosterData {
        media: "bafkiufjkssmvjby7srbr44ivexsexqvdvjby7hhoobl3q3twim3bgxffrm".to_string(),
        media_hash: Base64VecU8::from(b"w5SZrIcpoakfcRUl5EvCa4hy2ZzscFe4bnZDNhNcpYs=".to_vec()),
...
fn burn_token_by_oracle_for_invalid_owner() {
    ...
    let reference_booster_data = BalanceBoosterData {
        media: "bafkiufjkssmvjby7srbr44ivexs74937vjby7hhoobl3q3twim3bgxffrm".to_string(),
        media_hash: Base64VecU8::from(b"w5SZrIcpoakfcRUl5EvCqerjZzscFe4bnZDNhNcpYs=".to_vec()),
        denomination: U128(2_000_000),
    };
...
fn burn_token_not_by_oracle() {
    ...
    let reference_booster_data = BalanceBoosterData {
        media: "bafkiufjkssmvjby7srbr44iv84ij4qvdvjby7hhoobl3q3twim3bgxffrm".to_string(),
        media_hash: Base64VecU8::from(b"w5SZrIcpoakfcRUl5EvCaoi8fuzscFe4bnZDNhNcpYs=".to_vec()),
        denomination: U128(2_000_000),
    };
